...
import org.twc.terminator.t2dsl_compiler.T2_2_HElib_CKKS;
import org.twc.terminator.t2dsl_compiler.T2_Compiler;

@TestInstance(TestInstance.Lifecycle.PER_CLASS)
public class HElibCKKSTest extends FloatingPointTest {

  public T2_Compiler getT2Compiler(SymbolTable symbol_table,
                                   String config, int word_sz) {
    return new T2_2_HElib_CKKS(symbol_table, config);
  }
